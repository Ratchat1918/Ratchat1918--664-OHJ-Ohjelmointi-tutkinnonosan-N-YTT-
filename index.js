...
function openChart() {
    ...
    ostoskoriStr+=`<h2>${tuodetOstoskorissa.length} tuotetta, yhteensä ${ostosKoriSumma} €</h2>`;
    shoppingPanel.innerHTML=`<span id="closeBtnShopping" onclick="closeShoppingPanel()">&times;</span><h2>Ostoskori</h2>${ostoskoriStr}`;
